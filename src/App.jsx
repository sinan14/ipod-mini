...
import Case from './Components/case/Case'; // Import iPod body file
...
import song1Img from './assets/Post Malone - White Iverson.png';
import song2Img from './assets/John Denver - Country Roads.jpg';
import song3Img from './assets/Sigrid - High Five.png';
import song4Img from './assets/Khalid - Young Dumb Broke.jpg';
import song5Img from './assets/Never Gonna Give You Up.png';
  ...
  updateActiveMenu = (direction, menu) => {
    ...
    if (direction === 1) {
      ...
      if (this.state.active >= max) {
        ...
        //Otherwise, it simply increases active by 1.
    ...
    // If the direction value is not 1
      ...
      if (this.state.active <= min) {
        ...
        //Otherwise, it simply decreases active by 1.
        this.setState({ active: this.state.active - 1 });
      }
    }
  };
