...
export default class Wheel extends React.Component {
  ...
  render() {
    ...
    return (
      <div className={styles['wheel-container']} id='wheel-container'>
        <div
          className={styles['wheel']}
          id='wheel'
          style={{ backgroundColor: wheelColor }}
        >
          <div className={styles['control'] + ' ' + styles['menu']} id='menu'>
            <div style={{ color: theme }}>MENU</div>
          </div>
          <div
            className={styles['control'] + ' ' + styles['forward']}
            id='forward'
          >
            <AiOutlineForward style={{ color: theme }} />
          </div>
          <div
            className={styles['control'] + ' ' + styles['play-pause']}
            id='play-pause'
          >
            <div>
          ...
          <div
            className={styles['control'] + ' ' + styles['reverse']}
            id='reverse'
          >
        ...
        <div
          ...
          className={styles.control + ' ' + styles.blank}
          id='blank'
          onClick={() => {
            changeMenuForward(active, currentMenu);
          }}
        >
          <FaApple style={{ color: wheelColor }} />
        </div>
      </div>
    );
  }
